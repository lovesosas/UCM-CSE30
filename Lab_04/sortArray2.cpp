...
int main(){
  ...
  cout << "Sort in ascending (1) or descending (0) order?: "; //ask for choice
  cin >> sortChoice; //insert choice

  InsertionSort(sortChoice, array, sizeOfArray); //call function InserionSort with these arguments
