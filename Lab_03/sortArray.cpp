...
{
  //declare variables
  int tempHolder; //variable to hold or copy int
  int sizeOfArray;
  cout << "Enter size of array: " << endl; //output input
  cin >> sizeOfArray;
  ...
  //print out new ascending array
  cout << "This is the sorted array in ascending order:" << endl;
  for(int i =0; i<sizeOfArray;i++){
    cout << array[i] << " " << endl;
  }
  cout << "The algorithim selected the minimum for the traverse" << endl;
  return 0;
  }
